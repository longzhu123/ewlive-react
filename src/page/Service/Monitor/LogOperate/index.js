...
//操作日志管理组件
class LogOperate extends PureComponent {
...
const mapState = (state) => ({
    logOperateList: state.get("logOperateSettingReducer").get("logOperateList"),
    selectIds: state.get("logOperateSettingReducer").get("selectIds"),
    pageIndex: state.get("logOperateSettingReducer").get("pageIndex"),
    totalSize: state.get("logOperateSettingReducer").get("totalSize"),
    queryObj: state.get("logOperateSettingReducer").get("queryObj")
});
...
export default connect(mapState, mapDispatchToProps)(LogOperate);